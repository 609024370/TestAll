...
typedef int(*LMC1_GETFONTRECORD)(int& nFontIndex, TCHAR szFontName[256], DWORD&  dwFontAttrib);
...
typedef int(*LMC1_MARKLINE)(double dX1, double dY1, double dX2, double dY2, int iPen);

typedef int(*LMC1_MARKPOINT)(double x, double y, double delay, int iPen);
...
typedef int(*LMC1_SETENTITYNAME)(int nEntityIndex, TCHAR  szEntName[256]);

typedef int(*LMC1_GETHATCHENTPARAM2)(TCHAR* pHatchName,
	BOOL& bEnableContour,
	int nParamIndex,
	int& bEnableHatch,
	BOOL& bContourFirst,
...
typedef int(*LMC1_SETHATCHENTPARAM2)(TCHAR* pHatchName,
	BOOL& bEnableContour,
	int nParamIndex,
	int& bEnableHatch,
	BOOL& bContourFirst,
...
typedef int(*LMC1_UNHATCHENT)(TCHAR* pHatchEntName);
