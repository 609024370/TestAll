...
template<>
inline void Euresys::eVision::Internal::Properties::Helpers<Easy>::SetImpl(Easy* wrapper, void* internalObject)
{
  wrapper->wrappedFunctions_Easy_.SetImpl(internalObject);
}
template<>
inline void* Euresys::eVision::Internal::Properties::Helpers<Easy>::GetImpl(Easy* wrapper)
{
  return wrapper->wrappedFunctions_Easy_.GetImpl();
}
template<>
inline void Euresys::eVision::Internal::Properties::Helpers<EasyColor>::SetImpl(EasyColor* wrapper, void* internalObject)
{
  wrapper->wrappedFunctions_EasyColor_.SetImpl(internalObject);
}
template<>
inline void* Euresys::eVision::Internal::Properties::Helpers<EasyColor>::GetImpl(EasyColor* wrapper)
{
  return wrapper->wrappedFunctions_EasyColor_.GetImpl();
}
template<>
...
template<>
inline void Euresys::eVision::Internal::Properties::Helpers<EasyImage>::SetImpl(EasyImage* wrapper, void* internalObject)
{
  wrapper->wrappedFunctions_EasyImage_.SetImpl(internalObject);
}
template<>
inline void* Euresys::eVision::Internal::Properties::Helpers<EasyImage>::GetImpl(EasyImage* wrapper)
{
  return wrapper->wrappedFunctions_EasyImage_.GetImpl();
}
template<>
inline void Euresys::eVision::Internal::Properties::Helpers<EasyObject>::SetImpl(EasyObject* wrapper, void* internalObject)
{
  wrapper->wrappedFunctions_EasyObject_.SetImpl(internalObject);
}
template<>
inline void* Euresys::eVision::Internal::Properties::Helpers<EasyObject>::GetImpl(EasyObject* wrapper)
{
  return wrapper->wrappedFunctions_EasyObject_.GetImpl();
}
template<>
...
template<>
inline void Euresys::eVision::Internal::Properties::Helpers<LicensingHelpers>::SetImpl(LicensingHelpers* wrapper, void* internalObject)
{
  wrapper->wrappedFunctions_LicensingHelpers_.SetImpl(internalObject);
}
template<>
inline void* Euresys::eVision::Internal::Properties::Helpers<LicensingHelpers>::GetImpl(LicensingHelpers* wrapper)
{
  return wrapper->wrappedFunctions_LicensingHelpers_.GetImpl();
}
template<>
