#ifndef __WRAPPER_INTERNAL_LEGACY_OPEN_EVISION_1_2_MODULEHANDLER_LEGACY_OPEN_EVISION_1_2_1_2__
#define __WRAPPER_INTERNAL_LEGACY_OPEN_EVISION_1_2_MODULEHANDLER_LEGACY_OPEN_EVISION_1_2_1_2__
#include <string>
#include <windows.h>
#include "ScopeCriticSec_Legacy_Open_eVision_1_2.h"
  ...
  namespace Internal_Legacy_Open_eVision_1_2
  {
    ...
    public:
      ...
      ModuleHandler(char* moduleName, HKEY keyMain, char* regPath, char* regValue)
      {
        ...
        LONG returnStatus;
        DWORD dwType=REG_SZ;
        returnStatus = ::RegOpenKeyExA(keyMain, regPath, 0L,  KEY_ALL_ACCESS, &hKey);
...
#endif // __WRAPPER_INTERNAL_LEGACY_OPEN_EVISION_1_2_MODULEHANDLER_LEGACY_OPEN_EVISION_1_2_1_2__
